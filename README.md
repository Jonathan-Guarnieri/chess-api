...
5) implementar i18n
5.1) implementar concerns para lidar com mensagens de erro padronizadas e utilizando i18n
6) verificar se podemos usar keepttl no redis ao inves do score
